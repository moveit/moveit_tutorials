...
if __name__ == "__main__":
    ...
    TARGET_POS2 = [[0.17 * np.cos(x * np.pi / 180) + CENTER_POS[0], 0.21 * np.sin(x * np.pi / 180) + CENTER_POS[1], 0.44] for x in np.linspace(-160, 200, 20)]
    TARGET_POS3 = [[0.17 * np.cos(x * np.pi / 180) + CENTER_POS[0], 0.25 * np.sin(x * np.pi / 180) + CENTER_POS[1], 0.39] for x in np.linspace(190, -160, 20)]
    TARGET_POS4 = [[0.17 * np.cos(x * np.pi / 180) + CENTER_POS[0], 0.27 * np.sin(x * np.pi / 180) + CENTER_POS[1], 0.34] for x in np.linspace(-160, 120, 20)]
    # TARGET_POS = np.concatenate([TARGET_POS1, TARGET_POS2, TARGET_POS3, TARGET_POS4])
    TARGET_POS = np.concatenate([TARGET_POS1, TARGET_POS2])
