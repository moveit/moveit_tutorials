...
The kinematics.yaml file generated by the MoveIt! Setup Assistant is the primary configuration file for kinematics for MoveIt!. You can see an entire example file for the Panda robot in the `panda_moveit_config GitHub project <https://github.com/ros-planning/panda_moveit_config/blob/master/config/kinematics.yaml>`_: ::
