...
window.Modernizr = function(a, b, c) {
    ...
    e.inputtypes = function(a) {
      for (var d = 0, e, f, h, i = a.length; d < i; d++)
        k.setAttribute('type', f = a[d]), e = k.type !== 'text',
                                          e &&
            (k.value = l, k.style.cssText = 'position:absolute;visibility:hidden;',
             /^range$/.test(f) && k.style.WebkitAppearance !== c ?
                 (g.appendChild(k), h = b.defaultView,
                  e = h.getComputedStyle && h.getComputedStyle(k, null).WebkitAppearance !== 'textfield' &&
                      k.offsetHeight !== 0,
                  g.removeChild(k)) :
                 /^(search|tel)$/.test(f) ||
  ...
  var d = '2.6.2', e = {}, f = !0, g = b.documentElement, h = 'modernizr', i = b.createElement(h), j = i.style,
      ...
      y = function(a, c, d, e) {
        ...
        return f = ['&#173;', '<style id="s', h, '">', a, '</style>'].join(''), l.id = h, (m ? l : n).innerHTML += f,
               n.appendChild(l),
               m ||
                   (n.style.background = '', n.style.overflow = 'hidden', k = g.style.overflow,
                    g.style.overflow = 'hidden', g.appendChild(n)),
               i = c(l, a), m ? l.parentNode.removeChild(l) : (n.parentNode.removeChild(n), g.style.overflow = k), !!i
      }, z = function(b) {
          ...
          return f ||
                     (e.setAttribute || (e = b.createElement('div')),
                      e.setAttribute && e.removeAttribute &&
                          (e.setAttribute(d, ''), f = F(e[d], 'function'), F(e[d], 'undefined') || (e[d] = c),
                           e.removeAttribute(d))),
                 e = null, f
        }
        var a = {
  ...
  return e.input || K(),
         ...
         e._version = d, e._prefixes = n, e._domPrefixes = q, e._cssomPrefixes = p, e.mq = z, e.hasEvent = A,
          ...
          (e && (e = d(e) ? e : e[a] || e[g] || e[a.split('/').pop().split('?')[0]]),
           i.instead ?
               ...
               (y[i.url] ? i.noexec = !0 : y[i.url] = 1,
                f.load(
                    i.url, i.forceCSS || !i.forceJS && 'css' == i.url.split('.').pop().split('?').shift() ? 'c' : c,
